          ...
          <div css={winner(roomsResults)}>
            <div css={description(roomsResults)}>
              {roomsResults.winnerJob === 'MAFIA' ? (
                ...
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <circle cx="14.6436" cy="15.6042" r="2.5" fill="#210909" fill-opacity="0.8" />
                  <circle cx="27.6436" cy="15.6042" r="2.5" fill="#210909" fill-opacity="0.8" />
                  <path
            ...
            <div css={winnerGroup}>
              {roomsResults.winner.map(winnerPlayer => (
                <PlayerResult victory={roomsResults.winnerJob} player={winnerPlayer} />
              ))}
            </div>
          </div>
          <div css={loserGroup}>
