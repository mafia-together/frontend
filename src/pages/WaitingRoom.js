...
export default function WaitingRoom() {
    ...
    const InviteLinkCopyCss = styled.button`
        display: flex;
        gap: 10px;
    ...
    return (
        <AppContainerCSS>
            <div>
                <TopEnter type="waitingRoom" onModal={onModal} />
                <div css={middle}>
                    <div css={textGroup}>
                        <p css={subTitle}>참가목록</p>
                        <p css={number}>4/6</p>
                    </div>
                    <PlayerGird type="waiting">
                ...
                <div css={bottom} onClick={onGameStart}>
                    <BigButton type={ConstantsCss.emphasis} use={"gameStart"} />
                </div>
